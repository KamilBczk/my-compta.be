...
export async function generateMetadata({
  ...
  return {
    title: dictionary.privacy.title + " | My Compta",
    description: lang === "fr"
      ? "Politique de confidentialité de MY COMPTA - Protection des données personnelles conforme au RGPD. Découvrez comment nous collectons et utilisons vos données."
      : "Privacy policy of MY COMPTA - Personal data protection in accordance with GDPR. Learn how we collect and use your data.",
  };
}
