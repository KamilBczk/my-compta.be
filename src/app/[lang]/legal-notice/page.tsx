...
export async function generateMetadata({
  ...
  return {
    title: dictionary.legal.title + " | My Compta",
    description: lang === "fr"
      ? "Mentions légales de MY COMPTA - Société à responsabilité limitée, BCE 0746.708.869, expert comptable à Bruxelles."
      : "Legal notice of MY COMPTA - Limited liability company, BCE 0746.708.869, chartered accountant in Brussels.",
  };
}
